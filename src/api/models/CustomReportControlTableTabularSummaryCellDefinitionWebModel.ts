 ...
 */
export type CustomReportControlTableTabularSummaryCellDefinitionWebModel = {
  /**
...
export namespace CustomReportControlTableTabularSummaryCellDefinitionWebModel {
  /**
   * the discriminator for the model if required for more complex api's
   */
  export const discriminator = 'CustomReportControlTableTabularSummaryCellDefinitionWebModel';
}
