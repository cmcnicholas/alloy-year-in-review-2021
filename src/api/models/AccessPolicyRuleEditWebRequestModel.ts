 ...
 */
export type AccessPolicyRuleEditWebRequestModel = {
  /**
...
export namespace AccessPolicyRuleEditWebRequestModel {
  /**
   * the discriminator for the model if required for more complex api's
   */
  export const discriminator = 'AccessPolicyRuleEditWebRequestModel';
}
