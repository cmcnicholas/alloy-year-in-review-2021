...
export type WorkflowGetActionParametersWebResponseModel = {
  ...
  /**
   * Complete set of parameters needed by an action of queried type and position in workflow.  This can contain
...
export namespace WorkflowGetActionParametersWebResponseModel {
  /**
   * the discriminator for the model if required for more complex api's
   */
  export const discriminator = 'WorkflowGetActionParametersWebResponseModel';
}
