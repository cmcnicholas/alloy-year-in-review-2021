 ...
 */
export type DrivingRouteCreateWebRequestModel = {
  /**
   * Route name
   */
  name: string;
...
export namespace DrivingRouteCreateWebRequestModel {
  /**
   * the discriminator for the model if required for more complex api's
   */
  export const discriminator = 'DrivingRouteCreateWebRequestModel';
}
