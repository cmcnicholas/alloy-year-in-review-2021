 ...
 */
export type WorkflowActionGroupAddActionWebRequestModel = {
  /**
...
export namespace WorkflowActionGroupAddActionWebRequestModel {
  /**
   * the discriminator for the model if required for more complex api's
   */
  export const discriminator = 'WorkflowActionGroupAddActionWebRequestModel';
}
