...
export interface SyncService {
   ...
   * @returns any
   */
  syncBootStrap(requestBody: SyncBootstrapItemsRequestModel): Promise<any>;
   ...
   */
  syncBootStrapApiRequestOptions(requestBody: SyncBootstrapItemsRequestModel): ApiRequestOptions;
   ...
   * @returns any
   */
  syncBootStrapObsolete(requestBody: SyncBootstrapItemsRequestModel): Promise<any>;
   ...
   * @returns any
   */
  syncDelta(requestBody: SyncDeltaItemsRequestModel): Promise<any>;
   ...
   * @returns ApiRequestOptions the request options to fulfill a http request
   */
  syncDeltaApiRequestOptions(requestBody: SyncDeltaItemsRequestModel): ApiRequestOptions;
   ...
   * @returns any
   */
  syncDeltaObsolete(requestBody: SyncDeltaItemsRequestModel): Promise<any>;
   ...
   * @returns ApiRequestOptions the request options to fulfill a http request
   */
  syncDeltaObsoleteApiRequestOptions(requestBody: SyncDeltaItemsRequestModel): ApiRequestOptions;
}
